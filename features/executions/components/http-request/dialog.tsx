...
export const HttpRequestDialog = ({
  ...
  const watchVariableName = form.watch("variableName") || "myApiCall"; // to make the variable name in the form description dynamic "changes by changing the variable name"
